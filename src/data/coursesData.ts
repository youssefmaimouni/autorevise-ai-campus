...
Cette séance d'introduction couvre les fondements des bases de données. Elle commence par identifier les problèmes des systèmes de fichiers traditionnels et présente l'approche "Base de Données" avec ses concepts de modélisation et l'architecture à trois niveaux (conceptuel, externe, interne). La séance explore ensuite l'algèbre relationnelle, le fondement théorique de SQL, en détaillant les opérations clés comme la projection et la restriction. Enfin, elle introduit le langage SQL, en couvrant son histoire, ses principaux langages (LDD, LMD, LCD), les types de données, la création de tables, la manipulation des données (SELECT, INSERT, UPDATE, DELETE), les jointures, les transactions, la gestion des vues et le contrôle des accès.
  ...
  sections: [
    {
      title: "1. Introduction aux Bases de Données (BDD)",
      content: [
        {
          subtitle: "Problèmes de la gestion de données traditionnelle",
          points: [
        ...
        {
          subtitle: "L'approche Bases de Données",
          points: [
            ...
            "Utilisation d'un SGBD pour l’interrogation, la cohérence, le partage, la sécurité et la gestion des pannes."
          ]
        },
        {
          subtitle: "Architecture à trois niveaux (ANSI-SPARC)",
          points: [
            "Schéma Conceptuel : Vue globale logique indépendante de l’implémentation.",
            "Schéma Interne : Description physique des données.",
            "Schéma Externe : Vue partielle pour chaque utilisateur ou application."
          ]
        }
      ]
    },
    {
      title: "2. Le Modèle Relationnel et son Algèbre",
      content: [
        {
          subtitle: "Concepts fondamentaux",
          points: [
            "Proposé par E. F. Codd en 1970.",
            "Relation = Table, Tuple = Ligne, Attribut = Colonne.",
            "Clé primaire : identifie de manière unique chaque ligne."
          ]
        },
        {
          subtitle: "Opérations de l'Algèbre Relationnelle",
          points: [
            "Opérations ensemblistes : UNION, INTERSECTION, DIFFÉRENCE.",
            "Opérations spécifiques : PROJECTION, RESTRICTION, PRODUIT CARTÉSIEN, JOINTURE, DIVISION."
          ]
        }
      ]
    },
    {
      title: "3. Introduction au Langage SQL",
      content: [
        {
          subtitle: "Origines et Évolutions",
          points: [
            "SQL est un langage déclaratif standardisé (SQL-86, SQL-92, SQL-99)."
          ]
        },
        {
          subtitle: "Composants de SQL",
          points: [
            "LDD : CREATE, ALTER, DROP.",
            "LMD : SELECT, INSERT, UPDATE, DELETE.",
            "LCD : GRANT, REVOKE, COMMIT, ROLLBACK."
          ]
        },
        {
    ...
    {
      title: "4. Langage de Définition de Données (LDD)",
      content: [
        {
          subtitle: "Création de Tables",
          code: `
CREATE TABLE VINS (
    NV INT PRIMARY KEY,
    ...
    NVT INT REFERENCES VITICULTEURS(NVT)
        ...
        {
          subtitle: "Contraintes d'intégrité",
          points: [
            "NOT NULL, UNIQUE, PRIMARY KEY, FOREIGN KEY, CHECK, DEFAULT."
          ]
        },
        {
          subtitle: "Vues et Index",
          points: [
            "Vue = table virtuelle (`CREATE VIEW ...`).",
            "Index = structure pour accélérer les recherches (`CREATE INDEX ...`)."
          ]
        }
      ]
    },
    {
      title: "5. Langage de Manipulation de Données (LMD)",
      content: [
        {
          subtitle: "`SELECT` : Interroger les données",
          code: `
...
ORDER BY colonne;
        ...
        {
          subtitle: "Fonctions d'Agrégation",
          points: [
            "COUNT(), SUM(), AVG(), MIN(), MAX()."
          ]
        },
        {
          subtitle: "Requêtes Imbriquées",
          points: [
            "Utilisées dans WHERE, HAVING, FROM avec IN, EXISTS, ALL, etc."
          ]
        },
        {
    ...
    {
      title: "6. Contrôle et Gestion Avancée",
      content: [
        {
          subtitle: "Transactions (ACID)",
          points: [
        ...
        },
        {
          ...
          code: `
GRANT SELECT ON VINS TO USER;
REVOKE ALL ON VINS FROM USER;
          `
        },
        {
          subtitle: "Déclencheurs (Triggers)",
          points: [
            "Défini selon le modèle ECA (Événement - Condition - Action)."
          ]
        }
      ]
    }
